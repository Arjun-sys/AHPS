...
def post_feedback(request):
  ...
  if request.method == "POST":
      ...
      consultationDateTime=request.POST.get('consultationDateTime',None)
      if feedback != '':  
        f = Feedback(sender=request.user, feedback=feedback,consultationDateTime=consultationDateTime)
        f.save()        
        print(feedback)   
